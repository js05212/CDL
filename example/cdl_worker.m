function mult_sdae_worker(gd,pls,bls,lv,lu,ln,prtrn,sv,fd,dpt,fr,nepo,sl)
...
if prtrn==0
    ...
    my.pretrain = sprintf('cdl%d',prtrn); % pretrain
end
rand('seed',11112);
...
tic;
S = cdl (S, X, X_valid, X_ori, 0.1,my,perm_idx); %%% Above here is all about initialize the network. Training appear here and only once!
