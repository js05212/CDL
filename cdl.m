...
for step=my.from:n_epochs
    ...
    ctrcmd = sprintf('export LD_LIBRARY_PATH=/ghome/hwangaz/usr/local/lib && ./ctr --directory %s --user ctr-data/folder%d/cf-train-1-users.dat --item ctr-data/folder%d/cf-train-1-items.dat --max_iter %d --num_factors %d --lambda_v %f --lambda_u %f --save_lag 1700 --random_seed 123 --theta_init %s/final.gamma >> %s/%s', ...
        my.save,my.folder,my.folder,max_iter,num_k,my.lv,my.lu,...
        my.save,...
        my.save,my.ctr_log);
